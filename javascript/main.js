        ...
        $(window).on('load resize', function() {
            ...
            if ( currMenuType !== menuType ) {
                ...
                if ( currMenuType === 'mobile' ) {
                    ...
                    var logomobileMenu = $('#mainnav-mobi').find('ul.menu >li').first().before('<li id="logo" class="logo-mobi"><a href="index.html"><img src="" alt="" data-width="122" data-height="34" data-retina=""></a></li>');
